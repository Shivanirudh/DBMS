...
CREATE TABLE MUSICIAN(
	...
	MUSICIAN_NAME VARCHAR2(20) CONSTRAINT music_null NOT NULL,
...
CREATE TABLE ALBUM(
	...
	ALBUM_NAME VARCHAR2(20) CONSTRAINT album_null NOT NULL,
	...
	STUDIO VARCHAR2(20) CONSTRAINT album_studio_null NOT NULL
			    CONSTRAINT album_fk REFERENCES STUDIO(STUDIO_NAME),
	GENRE VARCHAR2(3) CONSTRAINT check_genre  CHECK(genre in ('CAR','DIV','MOV','POP')),
	MUSICIAN NUMBER(5) REFERENCES MUSICIAN(MUSICIAN_ID)
);
...
CREATE TABLE SONG(
	TRACK_NO NUMBER(3),
	ALBUM_ID NUMBER(5) REFERENCES ALBUM(ALBUM_ID),
	SONG_NAME VARCHAR2(20) CONSTRAINT song_null NOT NULL,
	...
	CONSTRAINT check_length CHECK(SONG_LENGTH>7 AND SONG_GENRE='PAT') 
);
...
CREATE TABLE ARTIST(
	...
	ARTIST_NAME VARCHAR2(20) CONSTRAINT artist_null NOT NULL
);
...
INSERT INTO ALBUM VALUES( 1,'INDIGO','CHENNAI');
INSERT INTO ALBUM VALUES( 2,'BOMBAY','MUMBAI');
INSERT INTO ALBUM VALUES( 3,'BIGIL','KERALA');


REM ****** Populating Song Database

INSERT INTO SONG VALUES( 1,1,'UNDECIDED',123,'PAT');
INSERT INTO SONG VALUES( 2,1,'RED',321,'PAT');
INSERT INTO SONG VALUES( 3,2,'ARABIAN SEA',23,'PAT');

REM ****** Violating song genre
INSERT INTO SONG VALUES( 3,2,'ARABIAN SEA',23,'PHI');
REM ****** Violating song length
...
INSERT INTO SUNGBY VALUES( 1,2,3,'25-JUL-2019');
INSERT INTO SUNGBY VALUES( 1,2,2,'15-FEB-2018');
INSERT INTO SUNGBY VALUES( 3,2,1,'05-AUG-2017');
INSERT INTO SUNGBY VALUES( 2,3,2,'03-MAY-1996');
